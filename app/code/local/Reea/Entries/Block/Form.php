...
class Reea_Entries_Block_Form extends Mage_Adminhtml_Block_Catalog_Category_Edit_Form
{
    /**
            ...
            $this->setChild('delete_button',
                $this->getLayout()->createBlock('adminhtml/widget_button')
                    ->setData(array(
                        ...
                        'onclick'   => "promtcategoryDelete('" . $this->getUrl('*/*/delete', array('_current' => true)) . "', true, {$categoryId})",
                        'class' => 'delete'
                    ))
            );
        }
