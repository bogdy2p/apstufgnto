...
class Reea_Customergrid_Block_Adminhtml_Customer_Edit_Tab_Addresses  extends Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses
{
    /**
    ...
    public function initForm()
    {
        ...
        /*Alex Custom code - remove Fax, Vat Number*/
        $faxElement = $form->getElement('fax');
        if ($faxElement) {
            $fieldset->removeField($faxElement->getId());
        }
        $vatElement = $form->getElement('vat_id');
        if ($vatElement) {
            $fieldset->removeField($vatElement->getId());
        }
        /*end custom code*/
